...
function Voting({ data, user, onRefresh }) {
  ...
  if(!allOpen.length) return html`<main className="page"><header className="page-heading"><div className="eyebrow">Get your scores ready</div><h1>${settings.voting_page_title || 'Voting'}</h1></header></main>`;
